...
__minima_set_default minima_color_magenta (set_color magenta)
__minima_set_default minima_color_gray (set_color 93A1A1)
__minima_set_default minima_color_normal (set_color normal)

__minima_set_default minima_host_color $minima_color_blue
__minima_set_default minima_root_color $minima_color_red
__minima_set_default minima_username_color $minima_color_magenta
